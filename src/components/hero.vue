      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
        ...
        <div>
          <div class="mt-10">
            ...
            <div aria-hidden="true" class="pointer-events-none float-right lg:absolute lg:inset-y-0 lg:max-w-7xl lg:mx-auto lg:w-full">
              <div class="lg:mt-40 lg:mr-16">
            ...
            <a href="#" class="inline-block text-center border border-transparent rounded-md py-3 px-8 font-medium text-white transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">Hire Me</a>
          </div>
        </div>
      </div>
    </div>
